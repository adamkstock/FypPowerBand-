...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0010R.styleable.CoordinatorLayout_LayoutParams);
            this.gravity = obtainStyledAttributes.getInteger(C0010R.styleable.CoordinatorLayout_LayoutParams_android_layout_gravity, 0);
            this.mAnchorId = obtainStyledAttributes.getResourceId(C0010R.styleable.CoordinatorLayout_LayoutParams_layout_anchor, -1);
            this.anchorGravity = obtainStyledAttributes.getInteger(C0010R.styleable.CoordinatorLayout_LayoutParams_layout_anchorGravity, 0);
            this.keyline = obtainStyledAttributes.getInteger(C0010R.styleable.CoordinatorLayout_LayoutParams_layout_keyline, -1);
            this.mBehaviorResolved = obtainStyledAttributes.hasValue(C0010R.styleable.CoordinatorLayout_LayoutParams_layout_behavior);
            if (this.mBehaviorResolved) {
                this.mBehavior = CoordinatorLayout.parseBehavior(context, attributeSet, obtainStyledAttributes.getString(C0010R.styleable.CoordinatorLayout_LayoutParams_layout_behavior));
            }
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if ((!z && !z2) || actionMasked == 0) {
                ...
                if (i == 0) {
                    ...
                    behavior.onTouchEvent(this, view, null);
                }
            }
        }
        list.clear();
    ...
    public boolean onTouchEvent(android.view.MotionEvent r6) {
        /*
            r5 = this;
            int r0 = android.support.p000v4.view.MotionEventCompat.getActionMasked(r6)
            android.view.View r1 = r5.mBehaviorTouchView
            r2 = 1
            r3 = 0
            if (r1 != 0) goto L_0x0011
            boolean r1 = r5.performIntercept(r6, r2)
        ...
        L_0x0012:
            ...
            android.view.View r3 = r5.mBehaviorTouchView
            boolean r3 = r4.onTouchEvent(r5, r3, r6)
        L_0x0026:
            android.view.View r4 = r5.mBehaviorTouchView
        ...
        for (int i5 = 0; i5 < childCount; i5++) {
            ...
            if (layoutParams.isNestedScrollAccepted()) {
                ...
                if (behavior != null) {
                    ...
                    int max = i > 0 ? Math.max(i3, iArr3[0]) : Math.min(i3, iArr3[0]);
