...
class AppCompatDelegateImplV7 extends AppCompatDelegateImplBase implements Callback, LayoutInflaterFactory {
    ...
    private static final class PanelFeatureState {
        ...
        public void setStyle(Context context) {
            ...
            TypedArray obtainStyledAttributes = contextThemeWrapper.obtainStyledAttributes(C0251R.styleable.Theme);
            this.background = obtainStyledAttributes.getResourceId(C0251R.styleable.Theme_panelBackground, 0);
            this.windowAnimations = obtainStyledAttributes.getResourceId(C0251R.styleable.Theme_android_windowAnimationStyle, 0);
        ...
        public MenuView getListMenuView(MenuPresenter.Callback callback) {
            ...
            if (this.listMenuPresenter == null) {
                this.listMenuPresenter = new ListMenuPresenter(this.listPresenterContext, C0251R.layout.abc_list_menu_item_layout);
    ...
    private final class PanelMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public void onCloseMenu(MenuBuilder menuBuilder, boolean z) {
            ...
            PanelFeatureState access$700 = appCompatDelegateImplV7.findMenuPanel(menuBuilder);
            if (access$700 == null) {
                return;
            }
            if (z2) {
                AppCompatDelegateImplV7.this.callOnPanelClosed(access$700.featureId, access$700, rootMenu);
                AppCompatDelegateImplV7.this.closePanel(access$700, true);
                return;
            }
            AppCompatDelegateImplV7.this.closePanel(access$700, z);
        }
    ...
    private ViewGroup createSubDecor() {
        ViewGroup viewGroup;
        Context context;
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(C0251R.styleable.Theme);
        if (obtainStyledAttributes.hasValue(C0251R.styleable.Theme_windowActionBar)) {
            if (obtainStyledAttributes.getBoolean(C0251R.styleable.Theme_windowNoTitle, false)) {
                requestWindowFeature(1);
            } else if (obtainStyledAttributes.getBoolean(C0251R.styleable.Theme_windowActionBar, false)) {
                requestWindowFeature(AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR);
            }
            if (obtainStyledAttributes.getBoolean(C0251R.styleable.Theme_windowActionBarOverlay, false)) {
                requestWindowFeature(AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR_OVERLAY);
            }
            if (obtainStyledAttributes.getBoolean(C0251R.styleable.Theme_windowActionModeOverlay, false)) {
                requestWindowFeature(10);
            }
            this.mIsFloating = obtainStyledAttributes.getBoolean(C0251R.styleable.Theme_android_windowIsFloating, false);
            obtainStyledAttributes.recycle();
            LayoutInflater from = LayoutInflater.from(this.mContext);
            if (this.mWindowNoTitle) {
                if (this.mOverlayActionMode) {
                    viewGroup = (ViewGroup) from.inflate(C0251R.layout.abc_screen_simple_overlay_action_mode, null);
                } else {
                    viewGroup = (ViewGroup) from.inflate(C0251R.layout.abc_screen_simple, null);
                }
                ...
                viewGroup = (ViewGroup) from.inflate(C0251R.layout.abc_dialog_title_material, null);
                this.mOverlayActionBar = false;
                this.mHasActionBar = false;
            } else if (this.mHasActionBar) {
                TypedValue typedValue = new TypedValue();
                this.mContext.getTheme().resolveAttribute(C0251R.attr.actionBarTheme, typedValue, true);
                if (typedValue.resourceId != 0) {
                    context = new ContextThemeWrapper(this.mContext, typedValue.resourceId);
                } else {
                    context = this.mContext;
                }
                viewGroup = (ViewGroup) LayoutInflater.from(context).inflate(C0251R.layout.abc_screen_toolbar, null);
                this.mDecorContentParent = (DecorContentParent) viewGroup.findViewById(C0251R.C0253id.decor_content_parent);
            ...
            if (viewGroup != null) {
                if (this.mDecorContentParent == null) {
                    this.mTitleView = (TextView) viewGroup.findViewById(C0251R.C0253id.title);
                }
                ViewUtils.makeOptionalFitsSystemWindows(viewGroup);
                ViewGroup viewGroup2 = (ViewGroup) this.mWindow.findViewById(16908290);
                ContentFrameLayout contentFrameLayout = (ContentFrameLayout) viewGroup.findViewById(C0251R.C0253id.action_bar_activity_content);
    ...
    private void applyFixedSizeWindow() {
        ...
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(C0251R.styleable.Theme);
        obtainStyledAttributes.getValue(C0251R.styleable.Theme_windowMinWidthMajor, contentFrameLayout.getMinWidthMajor());
        obtainStyledAttributes.getValue(C0251R.styleable.Theme_windowMinWidthMinor, contentFrameLayout.getMinWidthMinor());
        if (obtainStyledAttributes.hasValue(C0251R.styleable.Theme_windowFixedWidthMajor)) {
            obtainStyledAttributes.getValue(C0251R.styleable.Theme_windowFixedWidthMajor, contentFrameLayout.getFixedWidthMajor());
        }
        if (obtainStyledAttributes.hasValue(C0251R.styleable.Theme_windowFixedWidthMinor)) {
            obtainStyledAttributes.getValue(C0251R.styleable.Theme_windowFixedWidthMinor, contentFrameLayout.getFixedWidthMinor());
        }
        if (obtainStyledAttributes.hasValue(C0251R.styleable.Theme_windowFixedHeightMajor)) {
            obtainStyledAttributes.getValue(C0251R.styleable.Theme_windowFixedHeightMajor, contentFrameLayout.getFixedHeightMajor());
        }
        if (obtainStyledAttributes.hasValue(C0251R.styleable.Theme_windowFixedHeightMinor)) {
            obtainStyledAttributes.getValue(C0251R.styleable.Theme_windowFixedHeightMinor, contentFrameLayout.getFixedHeightMinor());
        }
        obtainStyledAttributes.recycle();
    ...
    public android.support.p003v7.view.ActionMode startSupportActionModeFromWindow(android.support.p003v7.view.ActionMode.Callback r9) {
        ...
        L_0x0022:
            ...
            goto L_0x0137
        L_0x0028:
            android.support.v7.internal.widget.ActionBarContextView r1 = r8.mActionModeView
            r3 = 0
            r4 = 1
            ...
            int r6 = android.support.p003v7.appcompat.C0251R.attr.actionBarTheme
            ...
            r6.applyStyle(r5, r4)
            android.support.v7.internal.view.ContextThemeWrapper r5 = new android.support.v7.internal.view.ContextThemeWrapper
        ...
        L_0x0069:
            ...
            int r7 = android.support.p003v7.appcompat.C0251R.attr.actionModePopupWindowStyle
            r6.<init>(r5, r2, r7)
            ...
            int r7 = android.support.p003v7.appcompat.C0251R.attr.actionBarSize
            ...
            r5 = -2
            r1.setHeight(r5)
            android.support.v7.app.AppCompatDelegateImplV7$4 r1 = new android.support.v7.app.AppCompatDelegateImplV7$4
            r1.<init>()
            r8.mShowActionModePopup = r1
            goto L_0x00d5
        L_0x00b6:
            android.view.ViewGroup r1 = r8.mSubDecor
            int r5 = android.support.p003v7.appcompat.C0251R.C0253id.action_mode_bar_stub
            android.view.View r1 = r1.findViewById(r5)
            android.support.v7.internal.widget.ViewStubCompat r1 = (android.support.p003v7.internal.widget.ViewStubCompat) r1
            if (r1 == 0) goto L_0x00d5
            android.content.Context r5 = r8.getActionBarThemedContext()
            android.view.LayoutInflater r5 = android.view.LayoutInflater.from(r5)
            r1.setLayoutInflater(r5)
            android.view.View r1 = r1.inflate()
            android.support.v7.internal.widget.ActionBarContextView r1 = (android.support.p003v7.internal.widget.ActionBarContextView) r1
        ...
        L_0x00d5:
            ...
            android.support.v7.internal.widget.ActionBarContextView r1 = r8.mActionModeView
            r1.killMode()
            android.support.v7.internal.view.StandaloneActionMode r1 = new android.support.v7.internal.view.StandaloneActionMode
            android.support.v7.internal.widget.ActionBarContextView r5 = r8.mActionModeView
            android.content.Context r5 = r5.getContext()
            android.support.v7.internal.widget.ActionBarContextView r6 = r8.mActionModeView
        ...
        L_0x00f0:
            ...
            r1.invalidate()
            android.support.v7.internal.widget.ActionBarContextView r9 = r8.mActionModeView
            r9.initForMode(r1)
            r8.mActionMode = r1
            android.support.v7.internal.widget.ActionBarContextView r9 = r8.mActionModeView
            r0 = 0
            ...
            android.support.v7.app.AppCompatDelegateImplV7$5 r0 = new android.support.v7.app.AppCompatDelegateImplV7$5
            r0.<init>()
            r9.setListener(r0)
        ...
        if (!panelFeatureState.isOpen && !isDestroyed()) {
            ...
            if (windowCallback == null || windowCallback.onMenuOpened(panelFeatureState.featureId, panelFeatureState.menu)) {
                ...
                if (windowManager != null && preparePanel(panelFeatureState, keyEvent)) {
                    ...
                    i = -2;
                    panelFeatureState.isHandled = false;
                    WindowManager.LayoutParams layoutParams32 = new WindowManager.LayoutParams(i, -2, panelFeatureState.f17x, panelFeatureState.f18y, PointerIconCompat.TYPE_HAND, 8519680, -3);
    ...
    private boolean initializePanelMenu(PanelFeatureState panelFeatureState) {
        ...
        if ((panelFeatureState.featureId == 0 || panelFeatureState.featureId == 108) && this.mDecorContentParent != null) {
            ...
            theme.resolveAttribute(C0251R.attr.actionBarTheme, typedValue, true);
            Theme theme2 = null;
            if (typedValue.resourceId != 0) {
                theme2 = context.getResources().newTheme();
                theme2.setTo(theme);
                theme2.applyStyle(typedValue.resourceId, true);
                theme2.resolveAttribute(C0251R.attr.actionBarWidgetTheme, typedValue, true);
            } else {
                theme.resolveAttribute(C0251R.attr.actionBarWidgetTheme, typedValue, true);
            }
            if (typedValue.resourceId != 0) {
                if (theme2 == null) {
                    theme2 = context.getResources().newTheme();
    ...
    private boolean onKeyUpPanel(int r4, android.view.KeyEvent r5) {
        ...
        L_0x0006:
            ...
            android.support.v7.internal.widget.DecorContentParent r4 = r3.mDecorContentParent
            if (r4 == 0) goto L_0x0045
    ...
    private void invalidatePanelMenu(int i) {
        ...
        if (!this.mInvalidatePanelMenuPosted) {
            ViewGroup viewGroup = this.mWindowDecor;
            if (viewGroup != null) {
            ...
            if (this.mActionModeView.isShown()) {
                ...
                if (marginLayoutParams.topMargin != (rect2.top == 0 ? i : 0)) {
                    ...
                    if (view == null) {
                        ...
                        this.mStatusGuard.setBackgroundColor(this.mContext.getResources().getColor(C0251R.color.abc_input_method_navigation_guard));
