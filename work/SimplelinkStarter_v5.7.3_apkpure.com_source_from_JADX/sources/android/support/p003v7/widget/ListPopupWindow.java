...
public class ListPopupWindow {
    ...
    private static class DropDownListView extends ListViewCompat {
        ...
        public DropDownListView(Context context, boolean z) {
            super(context, null, C0251R.attr.dropDownListViewStyle);
            this.mHijackFocus = z;
            setCacheColorHint(0);
        }
    ...
    public ListPopupWindow(Context context) {
        this(context, null, C0251R.attr.listPopupWindowStyle);
    }

    public ListPopupWindow(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0251R.attr.listPopupWindowStyle);
    }
    ...
    public ListPopupWindow(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0251R.styleable.ListPopupWindow, i, i2);
        this.mDropDownHorizontalOffset = obtainStyledAttributes.getDimensionPixelOffset(C0251R.styleable.ListPopupWindow_android_dropDownHorizontalOffset, 0);
        this.mDropDownVerticalOffset = obtainStyledAttributes.getDimensionPixelOffset(C0251R.styleable.ListPopupWindow_android_dropDownVerticalOffset, 0);
    ...
    public void show() {
        ...
        if (this.mPopup.isShowing()) {
            ...
            i4 = buildDropDown;
            PopupWindow popupWindow22 = this.mPopup;
            z = false;
