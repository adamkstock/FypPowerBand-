...
public class ActionMenuPresenter extends BaseMenuPresenter implements SubUiVisibilityListener {
    ...
    private class ActionButtonSubmenu extends MenuPopupHelper {
        ...
        public ActionButtonSubmenu(Context context, SubMenuBuilder subMenuBuilder) {
            super(context, subMenuBuilder, null, false, C0251R.attr.actionOverflowMenuStyle);
    ...
    private class OverflowMenuButton extends TintImageView implements ActionMenuChildView {
        ...
        public OverflowMenuButton(Context context) {
            super(context, null, C0251R.attr.actionOverflowButtonStyle);
            setClickable(true);
            setFocusable(true);
            setVisibility(0);
            setEnabled(true);
    ...
    private class OverflowPopup extends MenuPopupHelper {
        public OverflowPopup(Context context, MenuBuilder menuBuilder, View view, boolean z) {
            super(context, menuBuilder, view, z, C0251R.attr.actionOverflowMenuStyle);
    ...
    public ActionMenuPresenter(Context context) {
        super(context, C0251R.layout.abc_action_menu_layout, C0251R.layout.abc_action_menu_item_layout);
    }
    ...
    public void onConfigurationChanged(Configuration configuration) {
        if (!this.mMaxItemsSet) {
            this.mMaxItems = this.mContext.getResources().getInteger(C0251R.integer.abc_max_action_buttons);
        }
        if (this.mMenu != null) {
    ...
    public boolean flagActionItems() {
        ...
        while (i14 < size) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                ...
                boolean z3 = (i11 > 0 || z2) && i13 > 0 && (!actionMenuPresenter.mStrictWidthLimit || i > 0);
                i3 = size;
                if (z3) {
