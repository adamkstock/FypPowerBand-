...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            this.gravity = -1;
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0251R.styleable.LinearLayoutCompat_Layout);
            this.weight = obtainStyledAttributes.getFloat(C0251R.styleable.LinearLayoutCompat_Layout_android_layout_weight, 0.0f);
            this.gravity = obtainStyledAttributes.getInt(C0251R.styleable.LinearLayoutCompat_Layout_android_layout_gravity, -1);
    ...
    public LinearLayoutCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0251R.styleable.LinearLayoutCompat, i, 0);
        int i2 = obtainStyledAttributes.getInt(C0251R.styleable.LinearLayoutCompat_android_orientation, -1);
        if (i2 >= 0) {
            setOrientation(i2);
        }
        int i3 = obtainStyledAttributes.getInt(C0251R.styleable.LinearLayoutCompat_android_gravity, -1);
        if (i3 >= 0) {
            setGravity(i3);
        }
        boolean z = obtainStyledAttributes.getBoolean(C0251R.styleable.LinearLayoutCompat_android_baselineAligned, true);
        if (!z) {
            setBaselineAligned(z);
        }
        this.mWeightSum = obtainStyledAttributes.getFloat(C0251R.styleable.LinearLayoutCompat_android_weightSum, -1.0f);
        this.mBaselineAlignedChildIndex = obtainStyledAttributes.getInt(C0251R.styleable.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        this.mUseLargestChild = obtainStyledAttributes.getBoolean(C0251R.styleable.LinearLayoutCompat_measureWithLargestChild, false);
        setDividerDrawable(obtainStyledAttributes.getDrawable(C0251R.styleable.LinearLayoutCompat_divider));
        this.mShowDividers = obtainStyledAttributes.getInt(C0251R.styleable.LinearLayoutCompat_showDividers, 0);
        this.mDividerPadding = obtainStyledAttributes.getDimensionPixelSize(C0251R.styleable.LinearLayoutCompat_dividerPadding, 0);
        obtainStyledAttributes.recycle();
    }
    ...
    public void measureVertical(int r34, int r35) {
        ...
        L_0x0148:
            ...
            int r6 = android.support.p000v4.view.ViewCompat.getMeasuredState(r3)
            int r6 = android.support.p003v7.internal.widget.ViewUtils.combineMeasuredStates(r10, r6)
        ...
        L_0x0213:
            ...
            r9 = r13
            r11 = 0
            int r4 = android.support.p000v4.view.ViewCompat.resolveSizeAndState(r4, r5, r11)
        ...
        L_0x02f9:
            ...
            r13.measure(r6, r15)
        L_0x0300:
            int r6 = android.support.p000v4.view.ViewCompat.getMeasuredState(r13)
            r6 = r6 & -256(0xffffffffffffff00, float:NaN)
            int r10 = android.support.p003v7.internal.widget.ViewUtils.combineMeasuredStates(r10, r6)
            r6 = r21
            goto L_0x0312
        L_0x030d:
            r6 = r11
        ...
        L_0x0383:
            ...
            int r0 = java.lang.Math.max(r0, r1)
            int r0 = android.support.p000v4.view.ViewCompat.resolveSizeAndState(r0, r11, r10)
    ...
    public void measureHorizontal(int r38, int r39) {
        ...
        L_0x017a:
            ...
            int r4 = r4 + r2
            int r5 = android.support.p000v4.view.ViewCompat.getMeasuredState(r3)
            r10 = r27
            int r5 = android.support.p003v7.internal.widget.ViewUtils.combineMeasuredStates(r10, r5)
        ...
        L_0x02c6:
            ...
            r4 = 0
            r8 = -1
            int r1 = android.support.p000v4.view.ViewCompat.resolveSizeAndState(r1, r3, r4)
        ...
        L_0x03b7:
            ...
            r14.measure(r3, r2)
        L_0x03be:
            int r2 = android.support.p000v4.view.ViewCompat.getMeasuredState(r14)
            r3 = -16777216(0xffffffffff000000, float:-1.7014118E38)
            r2 = r2 & r3
            int r10 = android.support.p003v7.internal.widget.ViewUtils.combineMeasuredStates(r10, r2)
            r2 = r23
            r3 = r24
            goto L_0x03d1
        L_0x03ce:
        ...
        L_0x04d8:
            ...
            r1 = r1 | r2
            int r2 = r10 << 16
            int r0 = android.support.p000v4.view.ViewCompat.resolveSizeAndState(r0, r4, r2)
    ...
    public void layoutHorizontal(int r25, int r26, int r27, int r28) {
        /*
            r24 = this;
            r6 = r24
            boolean r0 = android.support.p003v7.internal.widget.ViewUtils.isLayoutRtl(r24)
