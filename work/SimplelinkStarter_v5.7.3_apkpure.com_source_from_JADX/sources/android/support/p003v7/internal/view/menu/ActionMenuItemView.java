...
public class ActionMenuItemView extends AppCompatTextView implements ItemView, OnClickListener, OnLongClickListener, ActionMenuChildView {
    ...
    public ActionMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mAllowTextWithIcon = resources.getBoolean(C0251R.bool.abc_config_allowActionMenuItemTextWithIcon);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0251R.styleable.ActionMenuItemView, i, 0);
        this.mMinWidth = obtainStyledAttributes.getDimensionPixelSize(C0251R.styleable.ActionMenuItemView_android_minWidth, 0);
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        this.mAllowTextWithIcon = getContext().getResources().getBoolean(C0251R.bool.abc_config_allowActionMenuItemTextWithIcon);
