...
public class ActivityChooserModel extends DataSetObservable {
    ...
    private final class PersistHistoryAsyncTask extends AsyncTask<Object, Void, Void> {
        ...
        public java.lang.Void doInBackground(java.lang.Object... r15) {
            /*
                ...
                r6 = 0
                android.support.v7.internal.widget.ActivityChooserModel r7 = android.support.p003v7.internal.widget.ActivityChooserModel.this     // Catch:{ FileNotFoundException -> 0x00f3 }
                android.content.Context r7 = r7.mContext     // Catch:{ FileNotFoundException -> 0x00f3 }
                java.io.FileOutputStream r15 = r7.openFileOutput(r15, r3)     // Catch:{ FileNotFoundException -> 0x00f3 }
                org.xmlpull.v1.XmlSerializer r7 = android.util.Xml.newSerializer()
                r7.setOutput(r15, r6)     // Catch:{ IllegalArgumentException -> 0x00c2, IllegalStateException -> 0x009d, IOException -> 0x0078 }
                java.lang.String r8 = "UTF-8"
                java.lang.Boolean r9 = java.lang.Boolean.valueOf(r5)     // Catch:{ IllegalArgumentException -> 0x00c2, IllegalStateException -> 0x009d, IOException -> 0x0078 }
                r7.startDocument(r8, r9)     // Catch:{ IllegalArgumentException -> 0x00c2, IllegalStateException -> 0x009d, IOException -> 0x0078 }
                r7.startTag(r6, r1)     // Catch:{ IllegalArgumentException -> 0x00c2, IllegalStateException -> 0x009d, IOException -> 0x0078 }
                int r8 = r4.size()     // Catch:{ IllegalArgumentException -> 0x00c2, IllegalStateException -> 0x009d, IOException -> 0x0078 }
                r9 = 0
            L_0x0033:
                if (r9 >= r8) goto L_0x0065
                java.lang.Object r10 = r4.remove(r3)     // Catch:{ IllegalArgumentException -> 0x00c2, IllegalStateException -> 0x009d, IOException -> 0x0078 }
                android.support.v7.internal.widget.ActivityChooserModel$HistoricalRecord r10 = (android.support.p003v7.internal.widget.ActivityChooserModel.HistoricalRecord) r10     // Catch:{ IllegalArgumentException -> 0x00c2, IllegalStateException -> 0x009d, IOException -> 0x0078 }
                r7.startTag(r6, r0)     // Catch:{ IllegalArgumentException -> 0x00c2, IllegalStateException -> 0x009d, IOException -> 0x0078 }
                java.lang.String r11 = "activity"
                android.content.ComponentName r12 = r10.activity     // Catch:{ IllegalArgumentException -> 0x00c2, IllegalStateException -> 0x009d, IOException -> 0x0078 }
                java.lang.String r12 = r12.flattenToString()     // Catch:{ IllegalArgumentException -> 0x00c2, IllegalStateException -> 0x009d, IOException -> 0x0078 }
                r7.attribute(r6, r11, r12)     // Catch:{ IllegalArgumentException -> 0x00c2, IllegalStateException -> 0x009d, IOException -> 0x0078 }
                java.lang.String r11 = "time"
                long r12 = r10.time     // Catch:{ IllegalArgumentException -> 0x00c2, IllegalStateException -> 0x009d, IOException -> 0x0078 }
                java.lang.String r12 = java.lang.String.valueOf(r12)     // Catch:{ IllegalArgumentException -> 0x00c2, IllegalStateException -> 0x009d, IOException -> 0x0078 }
                r7.attribute(r6, r11, r12)     // Catch:{ IllegalArgumentException -> 0x00c2, IllegalStateException -> 0x009d, IOException -> 0x0078 }
                java.lang.String r11 = "weight"
                float r10 = r10.weight     // Catch:{ IllegalArgumentException -> 0x00c2, IllegalStateException -> 0x009d, IOException -> 0x0078 }
                java.lang.String r10 = java.lang.String.valueOf(r10)     // Catch:{ IllegalArgumentException -> 0x00c2, IllegalStateException -> 0x009d, IOException -> 0x0078 }
                r7.attribute(r6, r11, r10)     // Catch:{ IllegalArgumentException -> 0x00c2, IllegalStateException -> 0x009d, IOException -> 0x0078 }
                r7.endTag(r6, r0)     // Catch:{ IllegalArgumentException -> 0x00c2, IllegalStateException -> 0x009d, IOException -> 0x0078 }
                int r9 = r9 + 1
                goto L_0x0033
            L_0x0065:
                r7.endTag(r6, r1)     // Catch:{ IllegalArgumentException -> 0x00c2, IllegalStateException -> 0x009d, IOException -> 0x0078 }
                r7.endDocument()     // Catch:{ IllegalArgumentException -> 0x00c2, IllegalStateException -> 0x009d, IOException -> 0x0078 }
                android.support.v7.internal.widget.ActivityChooserModel r0 = android.support.p003v7.internal.widget.ActivityChooserModel.this
            ...
            L_0x0078:
                r0 = move-exception
                java.lang.String r1 = android.support.p003v7.internal.widget.ActivityChooserModel.LOG_TAG     // Catch:{ all -> 0x0076 }
                ...
                android.support.v7.internal.widget.ActivityChooserModel r2 = android.support.p003v7.internal.widget.ActivityChooserModel.this     // Catch:{ all -> 0x0076 }
                java.lang.String r2 = r2.mHistoryFileName     // Catch:{ all -> 0x0076 }
                r3.append(r2)     // Catch:{ all -> 0x0076 }
                java.lang.String r2 = r3.toString()     // Catch:{ all -> 0x0076 }
                android.util.Log.e(r1, r2, r0)     // Catch:{ all -> 0x0076 }
                android.support.v7.internal.widget.ActivityChooserModel r0 = android.support.p003v7.internal.widget.ActivityChooserModel.this
                r0.mCanReadHistoricalData = r5
                if (r15 == 0) goto L_0x00e7
                goto L_0x0072
            ...
            L_0x00e7:
                return r6
            L_0x00e8:
                android.support.v7.internal.widget.ActivityChooserModel r1 = android.support.p003v7.internal.widget.ActivityChooserModel.this
                r1.mCanReadHistoricalData = r5
                if (r15 == 0) goto L_0x00f2
                r15.close()     // Catch:{ IOException -> 0x00f2 }
            L_0x00f2:
                throw r0
            L_0x00f3:
                r0 = move-exception
                java.lang.String r1 = android.support.p003v7.internal.widget.ActivityChooserModel.LOG_TAG
                ...
                return r6
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p003v7.internal.widget.ActivityChooserModel.PersistHistoryAsyncTask.doInBackground(java.lang.Object[]):java.lang.Void");
        }
    }
    ...
    public void setActivitySorter(android.support.p003v7.internal.widget.ActivityChooserModel.ActivitySorter r3) {
        /*
            ...
            monitor-enter(r0)
            android.support.v7.internal.widget.ActivityChooserModel$ActivitySorter r1 = r2.mActivitySorter     // Catch:{ all -> 0x0016 }
    ...
    private void readHistoricalDataImpl() {
        ...
        L_0x001f:
            ...
            java.util.List<android.support.v7.internal.widget.ActivityChooserModel$HistoricalRecord> r3 = r10.mHistoricalRecords     // Catch:{ XmlPullParserException -> 0x00a0, IOException -> 0x0086 }
        ...
        L_0x0044:
            ...
            android.support.v7.internal.widget.ActivityChooserModel$HistoricalRecord r9 = new android.support.v7.internal.widget.ActivityChooserModel$HistoricalRecord     // Catch:{ XmlPullParserException -> 0x00a0, IOException -> 0x0086 }
        ...
        L_0x00c2:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p003v7.internal.widget.ActivityChooserModel.readHistoricalDataImpl():void");
    }
}
