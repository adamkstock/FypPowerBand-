...
public class AppCompatPopupWindow extends PopupWindow {
    ...
    public AppCompatPopupWindow(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0251R.styleable.PopupWindow, i, 0);
        if (obtainStyledAttributes.hasValue(C0251R.styleable.PopupWindow_overlapAnchor)) {
            setSupportOverlapAnchor(obtainStyledAttributes.getBoolean(C0251R.styleable.PopupWindow_overlapAnchor, false));
        }
        setBackgroundDrawable(obtainStyledAttributes.getDrawable(C0251R.styleable.PopupWindow_android_popupBackground));
