...
final class BackStackRecord extends FragmentTransaction implements BackStackEntry, OpGenerator {
    ...
    public boolean interactsWith(ArrayList<BackStackRecord> arrayList, int i, int i2) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            C0065Op op = (C0065Op) this.mOps.get(i4);
            ...
            if (!(i5 == 0 || i5 == i3)) {
                for (int i6 = i; i6 < i2; i6++) {
                    ...
                    for (int i7 = 0; i7 < size2; i7++) {
                        C0065Op op2 = (C0065Op) backStackRecord.mOps.get(i7);
        ...
        while (i < this.mOps.size()) {
            ...
            if (i2 != 1) {
                if (i2 == 2) {
                        ...
                        if (fragment5.mContainerId == i3) {
                            if (fragment5 == fragment3) {
                                ...
                                if (fragment5 == fragment4) {
                                    this.mOps.add(i4, new C0065Op(9, fragment5));
                                    i4++;
                                    fragment4 = null;
                                }
                                C0065Op op2 = new C0065Op(3, fragment5);
                    ...
                    if (i2 == 8) {
                        this.mOps.add(i, new C0065Op(9, fragment2));
                        i++;
