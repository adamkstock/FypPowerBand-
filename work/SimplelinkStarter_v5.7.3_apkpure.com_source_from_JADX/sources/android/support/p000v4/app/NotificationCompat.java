...
import android.support.compat.C0001R;
...
public class NotificationCompat {
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private android.widget.RemoteViews createRemoteViews(android.widget.RemoteViews r7, boolean r8) {
            /*
                r6 = this;
                int r0 = android.support.compat.C0001R.layout.notification_template_custom_big
                r1 = 1
                r2 = 0
                android.widget.RemoteViews r0 = r6.applyStandardTemplate(r1, r0, r2)
                int r3 = android.support.compat.C0001R.C0003id.actions
            ...
            L_0x0025:
                ...
                int r5 = android.support.compat.C0001R.C0003id.actions
                r0.addView(r5, r4)
                int r3 = r3 + 1
                goto L_0x0025
            L_0x003d:
            ...
            L_0x0041:
                r2 = 8
            L_0x0043:
                int r8 = android.support.compat.C0001R.C0003id.actions
                r0.setViewVisibility(r8, r2)
                int r8 = android.support.compat.C0001R.C0003id.action_divider
                r0.setViewVisibility(r8, r2)
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), z ? C0001R.layout.notification_action_tombstone : C0001R.layout.notification_action);
            remoteViews.setImageViewBitmap(C0001R.C0003id.action_image, createColoredBitmap(action.getIcon(), this.mBuilder.mContext.getResources().getColor(C0001R.color.notification_action_color_filter)));
            remoteViews.setTextViewText(C0001R.C0003id.action_text, action.title);
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0001R.C0003id.action_container, action.actionIntent);
            }
            if (VERSION.SDK_INT >= 15) {
                remoteViews.setContentDescription(C0001R.C0003id.action_container, action.title);
            }
            return remoteViews;
        }
    }
    ...
    static class NotificationCompatApi16Impl extends NotificationCompatBaseImpl {
        ...
        public Notification build(Builder builder, BuilderExtender builderExtender) {
            ...
            android.support.p000v4.app.NotificationCompatJellybean.Builder builder3 = r1;
            android.support.p000v4.app.NotificationCompatJellybean.Builder builder4 = new android.support.p000v4.app.NotificationCompatJellybean.Builder(builder2.mContext, builder2.mNotification, builder2.mContentTitle, builder2.mContentText, builder2.mContentInfo, builder2.mTickerView, builder2.mNumber, builder2.mContentIntent, builder2.mFullScreenIntent, builder2.mLargeIcon, builder2.mProgressMax, builder2.mProgress, builder2.mProgressIndeterminate, builder2.mUseChronometer, builder2.mPriority, builder2.mSubText, builder2.mLocalOnly, builder2.mExtras, builder2.mGroupKey, builder2.mGroupSummary, builder2.mSortKey, builder2.mContentView, builder2.mBigContentView);
            android.support.p000v4.app.NotificationCompatJellybean.Builder builder5 = builder3;
    ...
    static class NotificationCompatApi19Impl extends NotificationCompatApi16Impl {
        ...
        public Notification build(Builder builder, BuilderExtender builderExtender) {
            Builder builder2 = builder;
            android.support.p000v4.app.NotificationCompatKitKat.Builder builder3 = r1;
            android.support.p000v4.app.NotificationCompatKitKat.Builder builder4 = new android.support.p000v4.app.NotificationCompatKitKat.Builder(builder2.mContext, builder2.mNotification, builder2.mContentTitle, builder2.mContentText, builder2.mContentInfo, builder2.mTickerView, builder2.mNumber, builder2.mContentIntent, builder2.mFullScreenIntent, builder2.mLargeIcon, builder2.mProgressMax, builder2.mProgress, builder2.mProgressIndeterminate, builder2.mShowWhen, builder2.mUseChronometer, builder2.mPriority, builder2.mSubText, builder2.mLocalOnly, builder2.mPeople, builder2.mExtras, builder2.mGroupKey, builder2.mGroupSummary, builder2.mSortKey, builder2.mContentView, builder2.mBigContentView);
            android.support.p000v4.app.NotificationCompatKitKat.Builder builder5 = builder3;
            NotificationCompat.addActionsToBuilder(builder5, builder2.mActions);
            if (builder2.mStyle != null) {
                builder2.mStyle.apply(builder5);
            }
    ...
    static class NotificationCompatApi20Impl extends NotificationCompatApi19Impl {
        ...
        public Notification build(Builder builder, BuilderExtender builderExtender) {
            Builder builder2 = builder;
            android.support.p000v4.app.NotificationCompatApi20.Builder builder3 = r1;
            android.support.p000v4.app.NotificationCompatApi20.Builder builder4 = new android.support.p000v4.app.NotificationCompatApi20.Builder(builder2.mContext, builder2.mNotification, builder2.mContentTitle, builder2.mContentText, builder2.mContentInfo, builder2.mTickerView, builder2.mNumber, builder2.mContentIntent, builder2.mFullScreenIntent, builder2.mLargeIcon, builder2.mProgressMax, builder2.mProgress, builder2.mProgressIndeterminate, builder2.mShowWhen, builder2.mUseChronometer, builder2.mPriority, builder2.mSubText, builder2.mLocalOnly, builder2.mPeople, builder2.mExtras, builder2.mGroupKey, builder2.mGroupSummary, builder2.mSortKey, builder2.mContentView, builder2.mBigContentView, builder.mGroupAlertBehavior);
            android.support.p000v4.app.NotificationCompatApi20.Builder builder5 = builder3;
            NotificationCompat.addActionsToBuilder(builder5, builder2.mActions);
            if (builder2.mStyle != null) {
                builder2.mStyle.apply(builder5);
            }
    ...
    static class NotificationCompatApi21Impl extends NotificationCompatApi20Impl {
        ...
        public Notification build(Builder builder, BuilderExtender builderExtender) {
            Builder builder2 = builder;
            android.support.p000v4.app.NotificationCompatApi21.Builder builder3 = r1;
            android.support.p000v4.app.NotificationCompatApi21.Builder builder4 = new android.support.p000v4.app.NotificationCompatApi21.Builder(builder2.mContext, builder2.mNotification, builder2.mContentTitle, builder2.mContentText, builder2.mContentInfo, builder2.mTickerView, builder2.mNumber, builder2.mContentIntent, builder2.mFullScreenIntent, builder2.mLargeIcon, builder2.mProgressMax, builder2.mProgress, builder2.mProgressIndeterminate, builder2.mShowWhen, builder2.mUseChronometer, builder2.mPriority, builder2.mSubText, builder2.mLocalOnly, builder2.mCategory, builder2.mPeople, builder2.mExtras, builder2.mColor, builder2.mVisibility, builder2.mPublicVersion, builder2.mGroupKey, builder2.mGroupSummary, builder2.mSortKey, builder2.mContentView, builder2.mBigContentView, builder2.mHeadsUpContentView, builder.mGroupAlertBehavior);
            android.support.p000v4.app.NotificationCompatApi21.Builder builder5 = builder3;
            NotificationCompat.addActionsToBuilder(builder5, builder2.mActions);
            if (builder2.mStyle != null) {
                builder2.mStyle.apply(builder5);
            }
    ...
    static class NotificationCompatApi24Impl extends NotificationCompatApi21Impl {
        ...
        public Notification build(Builder builder, BuilderExtender builderExtender) {
            Builder builder2 = builder;
            android.support.p000v4.app.NotificationCompatApi24.Builder builder3 = r1;
            android.support.p000v4.app.NotificationCompatApi24.Builder builder4 = new android.support.p000v4.app.NotificationCompatApi24.Builder(builder2.mContext, builder2.mNotification, builder2.mContentTitle, builder2.mContentText, builder2.mContentInfo, builder2.mTickerView, builder2.mNumber, builder2.mContentIntent, builder2.mFullScreenIntent, builder2.mLargeIcon, builder2.mProgressMax, builder2.mProgress, builder2.mProgressIndeterminate, builder2.mShowWhen, builder2.mUseChronometer, builder2.mPriority, builder2.mSubText, builder2.mLocalOnly, builder2.mCategory, builder2.mPeople, builder2.mExtras, builder2.mColor, builder2.mVisibility, builder2.mPublicVersion, builder2.mGroupKey, builder2.mGroupSummary, builder2.mSortKey, builder2.mRemoteInputHistory, builder2.mContentView, builder2.mBigContentView, builder2.mHeadsUpContentView, builder.mGroupAlertBehavior);
            android.support.p000v4.app.NotificationCompatApi24.Builder builder5 = builder3;
            NotificationCompat.addActionsToBuilder(builder5, builder2.mActions);
            if (builder2.mStyle != null) {
                builder2.mStyle.apply(builder5);
            }
    ...
    public static abstract class Style {
        ...
        public android.widget.RemoteViews applyStandardTemplate(boolean r13, int r14, boolean r15) {
            ...
            L_0x0023:
                ...
                int r14 = android.support.compat.C0001R.C0003id.notification_background
                int r4 = android.support.compat.C0001R.C0002drawable.notification_bg_low
                r7.setInt(r14, r2, r4)
                int r14 = android.support.compat.C0001R.C0003id.icon
                int r4 = android.support.compat.C0001R.C0002drawable.notification_template_icon_low_bg
                r7.setInt(r14, r2, r4)
                goto L_0x0050
            L_0x0042:
                int r14 = android.support.compat.C0001R.C0003id.notification_background
                int r4 = android.support.compat.C0001R.C0002drawable.notification_bg
                r7.setInt(r14, r2, r4)
                int r14 = android.support.compat.C0001R.C0003id.icon
                int r4 = android.support.compat.C0001R.C0002drawable.notification_template_icon_bg
                r7.setInt(r14, r2, r4)
            L_0x0050:
                android.support.v4.app.NotificationCompat$Builder r14 = r12.mBuilder
            ...
            L_0x0070:
                ...
                int r13 = r13.icon
                if (r13 == 0) goto L_0x0104
                int r13 = android.support.compat.C0001R.dimen.notification_right_icon_size
                int r13 = r0.getDimensionPixelSize(r13)
                int r14 = android.support.compat.C0001R.dimen.notification_small_icon_background_padding
                ...
                int r14 = android.support.compat.C0001R.C0003id.right_icon
                r7.setImageViewBitmap(r14, r13)
                goto L_0x00b3
            L_0x00a4:
                int r13 = android.support.compat.C0001R.C0003id.right_icon
                android.support.v4.app.NotificationCompat$Builder r14 = r12.mBuilder
            ...
            L_0x00b9:
                ...
                int r13 = r13.icon
                if (r13 == 0) goto L_0x0104
                int r13 = android.support.compat.C0001R.C0003id.icon
                r7.setViewVisibility(r13, r9)
                int r13 = android.os.Build.VERSION.SDK_INT
                if (r13 < r3) goto L_0x00f5
                int r13 = android.support.compat.C0001R.dimen.notification_large_icon_width
                int r13 = r0.getDimensionPixelSize(r13)
                int r14 = android.support.compat.C0001R.dimen.notification_big_circle_margin
                int r14 = r0.getDimensionPixelSize(r14)
                int r13 = r13 - r14
                int r14 = android.support.compat.C0001R.dimen.notification_small_icon_size_as_large
                int r14 = r0.getDimensionPixelSize(r14)
                android.support.v4.app.NotificationCompat$Builder r1 = r12.mBuilder
                android.app.Notification r1 = r1.mNotification
                int r1 = r1.icon
            ...
            L_0x0104:
                ...
                int r13 = android.support.compat.C0001R.C0003id.title
                android.support.v4.app.NotificationCompat$Builder r14 = r12.mBuilder
            ...
            L_0x0113:
                ...
                int r13 = android.support.compat.C0001R.C0003id.text
                android.support.v4.app.NotificationCompat$Builder r14 = r12.mBuilder
            ...
            L_0x0132:
                ...
                int r13 = android.support.compat.C0001R.C0003id.info
                android.support.v4.app.NotificationCompat$Builder r14 = r12.mBuilder
            ...
            L_0x0149:
                ...
                int r13 = android.support.compat.C0001R.integer.status_bar_notification_info_maxnum
                int r13 = r0.getInteger(r13)
                android.support.v4.app.NotificationCompat$Builder r14 = r12.mBuilder
                int r14 = r14.mNumber
                if (r14 <= r13) goto L_0x0167
                int r13 = android.support.compat.C0001R.C0003id.info
                int r14 = android.support.compat.C0001R.string.status_bar_notification_info_overflow
                java.lang.String r14 = r0.getString(r14)
                r7.setTextViewText(r13, r14)
                goto L_0x0179
            L_0x0167:
                java.text.NumberFormat r13 = java.text.NumberFormat.getIntegerInstance()
                int r14 = android.support.compat.C0001R.C0003id.info
                android.support.v4.app.NotificationCompat$Builder r1 = r12.mBuilder
                int r1 = r1.mNumber
                long r1 = (long) r1
            ...
            L_0x0179:
                ...
                goto L_0x0146
            L_0x017f:
                int r1 = android.support.compat.C0001R.C0003id.info
            ...
            L_0x0184:
                ...
                int r1 = android.support.compat.C0001R.C0003id.text
                android.support.v4.app.NotificationCompat$Builder r2 = r12.mBuilder
                ...
                int r1 = android.support.compat.C0001R.C0003id.text2
                android.support.v4.app.NotificationCompat$Builder r2 = r12.mBuilder
            ...
            L_0x01b3:
                ...
                int r15 = android.support.compat.C0001R.dimen.notification_subtext_size
                int r15 = r0.getDimensionPixelSize(r15)
                float r15 = (float) r15
                int r0 = android.support.compat.C0001R.C0003id.text
                r7.setTextViewTextSize(r0, r9, r15)
            L_0x01c7:
                int r2 = android.support.compat.C0001R.C0003id.line1
                r3 = 0
                r4 = 0
                r5 = 0
                r6 = 0
            ...
            L_0x01d1:
                ...
                int r14 = android.support.compat.C0001R.C0003id.chronometer
                r7.setViewVisibility(r14, r9)
                int r14 = android.support.compat.C0001R.C0003id.chronometer
                android.support.v4.app.NotificationCompat$Builder r15 = r12.mBuilder
                long r0 = r15.getWhenIfShowing()
                ...
                goto L_0x021d
            L_0x020b:
                int r14 = android.support.compat.C0001R.C0003id.time
                r7.setViewVisibility(r14, r9)
                int r14 = android.support.compat.C0001R.C0003id.time
                android.support.v4.app.NotificationCompat$Builder r15 = r12.mBuilder
                long r0 = r15.getWhenIfShowing()
            ...
            L_0x021d:
                r14 = 1
            L_0x021e:
                int r15 = android.support.compat.C0001R.C0003id.right_side
            ...
            L_0x0226:
                ...
                int r14 = android.support.compat.C0001R.C0003id.line3
        ...
        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) {
            int i5 = C0001R.C0002drawable.notification_icon_background;
            if (i4 == 0) {
                i4 = 0;
            }
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            remoteViews.removeAllViews(C0001R.C0003id.notification_main_column);
            remoteViews.addView(C0001R.C0003id.notification_main_column, remoteViews2.clone());
            remoteViews.setViewVisibility(C0001R.C0003id.notification_main_column, 0);
            if (VERSION.SDK_INT >= 21) {
                remoteViews.setViewPadding(C0001R.C0003id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }

        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0001R.C0003id.title, 8);
            remoteViews.setViewVisibility(C0001R.C0003id.text2, 8);
            remoteViews.setViewVisibility(C0001R.C0003id.text, 8);
        }

        private int calculateTopPadding() {
            Resources resources = this.mBuilder.mContext.getResources();
            int dimensionPixelSize = resources.getDimensionPixelSize(C0001R.dimen.notification_top_pad);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0001R.dimen.notification_top_pad_large_text);
