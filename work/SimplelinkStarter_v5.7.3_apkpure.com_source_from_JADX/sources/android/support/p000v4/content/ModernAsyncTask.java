...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    static /* synthetic */ class C01014 {
        ...
        static {
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p000v4.content.ModernAsyncTask.C01014.<clinit>():void");
        }
    }
    ...
    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor executor, Params... paramsArr) {
        if (this.mStatus != Status.PENDING) {
            int i = C01014.$SwitchMap$android$support$v4$content$ModernAsyncTask$Status[this.mStatus.ordinal()];
            if (i == 1) {
