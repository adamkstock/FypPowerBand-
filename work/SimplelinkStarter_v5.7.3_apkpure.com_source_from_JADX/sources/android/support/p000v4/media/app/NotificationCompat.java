...
public class NotificationCompat {
    ...
    public static class DecoratedMediaCustomViewStyle extends MediaStyle {
        ...
        private void setBackgroundColor(RemoteViews remoteViews) {
            ...
            if (this.mBuilder.getColor() != 0) {
                ...
                i = this.mBuilder.mContext.getResources().getColor(C0057R.color.notification_material_background_media_default_color);
            }
            remoteViews.setInt(C0057R.C0059id.status_bar_latest_event_content, "setBackgroundColor", i);
        }
    }
    ...
    public static class MediaStyle extends Style {
        ...
        public RemoteViews generateContentView() {
            ...
            applyStandardTemplate.removeAllViews(C0057R.C0059id.media_actions);
            if (i > 0) {
                int i2 = 0;
                while (i2 < i) {
                    if (i2 < size) {
                        applyStandardTemplate.addView(C0057R.C0059id.media_actions, generateMediaActionButton((Action) this.mBuilder.mActions.get(this.mActionsToShowInCompact[i2])));
                        i2++;
                    } else {
            ...
            if (this.mShowCancelButton) {
                applyStandardTemplate.setViewVisibility(C0057R.C0059id.end_padder, 8);
                applyStandardTemplate.setViewVisibility(C0057R.C0059id.cancel_action, 0);
                applyStandardTemplate.setOnClickPendingIntent(C0057R.C0059id.cancel_action, this.mCancelButtonIntent);
                applyStandardTemplate.setInt(C0057R.C0059id.cancel_action, "setAlpha", this.mBuilder.mContext.getResources().getInteger(C0057R.integer.cancel_button_image_alpha));
            } else {
                applyStandardTemplate.setViewVisibility(C0057R.C0059id.end_padder, 0);
                applyStandardTemplate.setViewVisibility(C0057R.C0059id.cancel_action, 8);
            }
        ...
        private RemoteViews generateMediaActionButton(Action action) {
            ...
            remoteViews.setImageViewResource(C0057R.C0059id.action0, action.getIcon());
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0057R.C0059id.action0, action.getActionIntent());
            }
            if (VERSION.SDK_INT >= 15) {
                remoteViews.setContentDescription(C0057R.C0059id.action0, action.getTitle());
            }
            return remoteViews;
        }
        ...
        public RemoteViews generateBigContentView() {
            ...
            if (min > 0) {
                for (int i = 0; i < min; i++) {
                    applyStandardTemplate.addView(C0057R.C0059id.media_actions, generateMediaActionButton((Action) this.mBuilder.mActions.get(i)));
                }
            }
            if (this.mShowCancelButton) {
                applyStandardTemplate.setViewVisibility(C0057R.C0059id.cancel_action, 0);
