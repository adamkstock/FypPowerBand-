...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    class MediaBrowserServiceImplApi21 implements MediaBrowserServiceImpl, ServiceCompatProxy {
        ...
        public android.support.p000v4.media.MediaBrowserServiceCompatApi21.BrowserRoot onGetRoot(java.lang.String r5, int r6, android.os.Bundle r7) {
            /*
                r4 = this;
                r0 = 0
                ...
                r1.putInt(r3, r2)
                android.os.Messenger r2 = r4.mMessenger
            ...
            L_0x0046:
                ...
                goto L_0x0053
            L_0x004c:
                java.util.List<android.os.Bundle> r2 = r4.mRootExtrasList
                r2.add(r1)
                goto L_0x0053
            L_0x0052:
                r1 = r0
            L_0x0053:
                android.support.v4.media.MediaBrowserServiceCompat r2 = android.support.p000v4.media.MediaBrowserServiceCompat.this
                android.support.v4.media.MediaBrowserServiceCompat$BrowserRoot r5 = r2.onGetRoot(r5, r6, r7)
            ...
            L_0x0063:
                ...
                r1.putAll(r6)
            L_0x0070:
                android.support.v4.media.MediaBrowserServiceCompatApi21$BrowserRoot r6 = new android.support.v4.media.MediaBrowserServiceCompatApi21$BrowserRoot
                java.lang.String r5 = r5.getRootId()
                r6.<init>(r5, r1)
                return r6
            */
    ...
    private final class ServiceHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            switch (i) {
                case 1:
                    this.mServiceBinderImpl.connect(data.getString(MediaBrowserProtocol.DATA_PACKAGE_NAME), data.getInt(MediaBrowserProtocol.DATA_CALLING_UID), data.getBundle(str2), new ServiceCallbacksCompat(message.replyTo));
                    return;
                case 2:
                    this.mServiceBinderImpl.disconnect(new ServiceCallbacksCompat(message.replyTo));
                    return;
                case 3:
                    this.mServiceBinderImpl.addSubscription(data.getString(str4), BundleCompat.getBinder(data, str), data.getBundle(MediaBrowserProtocol.DATA_OPTIONS), new ServiceCallbacksCompat(message.replyTo));
                    return;
                case 4:
                    this.mServiceBinderImpl.removeSubscription(data.getString(str4), BundleCompat.getBinder(data, str), new ServiceCallbacksCompat(message.replyTo));
                    return;
                case 5:
                    this.mServiceBinderImpl.getMediaItem(data.getString(str4), (ResultReceiver) data.getParcelable(str3), new ServiceCallbacksCompat(message.replyTo));
                    return;
                case 6:
                    this.mServiceBinderImpl.registerCallbacks(new ServiceCallbacksCompat(message.replyTo), data.getBundle(str2));
                    return;
                case 7:
                    this.mServiceBinderImpl.unregisterCallbacks(new ServiceCallbacksCompat(message.replyTo));
                    return;
                case 8:
                    this.mServiceBinderImpl.search(data.getString(MediaBrowserProtocol.DATA_SEARCH_QUERY), data.getBundle(MediaBrowserProtocol.DATA_SEARCH_EXTRAS), (ResultReceiver) data.getParcelable(str3), new ServiceCallbacksCompat(message.replyTo));
                    return;
                case 9:
                    this.mServiceBinderImpl.sendCustomAction(data.getString(MediaBrowserProtocol.DATA_CUSTOM_ACTION), data.getBundle(MediaBrowserProtocol.DATA_CUSTOM_ACTION_EXTRAS), (ResultReceiver) data.getParcelable(str3), new ServiceCallbacksCompat(message.replyTo));
                    return;
                default:
                    StringBuilder sb = new StringBuilder();
