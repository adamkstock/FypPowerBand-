...
/* renamed from: com.ti.ble.ti.profiles.TILampControlProfileTableRow */
public class TILampControlProfileTableRow extends TableRow {
    Context context;
    ...
    TILampControlProfileTableRow(Context context2) {
        super(context2);
        this.context = context2;
        View inflate = LayoutInflater.from(context2).inflate(R.layout.lamp_table_row, null, false);
        addView(inflate);
