...
import com.p004ti.ti_oad.BluetoothLEController.Exceptions.BluetoothLEBluetoothEnableTimeoutException;
import com.p004ti.ti_oad.BluetoothLEController.Exceptions.BluetoothLEPermissionException;
import java.lang.Thread.State;
import java.util.ArrayList;
import java.util.List;

/* renamed from: com.ti.ti_oad.BluetoothLEController.BluetoothLEManager */
public class BluetoothLEManager {
    ...
    Runnable scanRoutine = new Runnable() {
        public void run() {
            ...
            C09341 r4 = new ScanCallback() {
                public void onScanResult(int i, ScanResult scanResult) {
                    super.onScanResult(i, scanResult);
                    if (!BluetoothLEManager.this.deviceInList(scanResult.getDevice())) {
                        BluetoothLEDevice bluetoothLEDevice = new BluetoothLEDevice(scanResult.getDevice(), BluetoothLEManager.this.f67c);
                        bluetoothLEDevice.f64m = BluetoothLEManager.this.f68m;
                        bluetoothLEDevice.f65sR = scanResult;
    ...
    /* renamed from: com.ti.ti_oad.BluetoothLEController.BluetoothLEManager$BluetoothLEManagerCB */
    ...
    public BluetoothLEManager(Context context) {
        ...
        this.f68m = (BluetoothManager) this.f67c.getSystemService("bluetooth");
        this.adapter = this.f68m.getAdapter();
    }
    ...
    public int checkPermission() {
        return ContextCompat.checkSelfPermission(this.f67c, "android.permission.ACCESS_FINE_LOCATION");
    }

    public void prepareForScanForDevices(Activity activity) {
        BluetoothAdapter adapter2 = this.f68m.getAdapter();
        if (adapter2 != null) {
    ...
    public void scanForDevices() {
        ...
        if (adapter2 != null) {
            ...
            if (ContextCompat.checkSelfPermission(this.f67c, "android.permission.ACCESS_FINE_LOCATION") == 0) {
                scanForDevices(0);
                return;
            }
    ...
    public void restartBluetooth(Context context, final Activity activity) {
        final BluetoothAdapter adapter2 = this.f68m.getAdapter();
    ...
    public BluetoothLEDevice deviceForBluetoothDev(BluetoothDevice bluetoothDevice) {
        for (int i = 0; i < this.deviceList.size(); i++) {
            ...
            if (bluetoothLEDevice.f62d.getAddress().toString().equalsIgnoreCase(bluetoothDevice.getAddress().toString())) {
                return bluetoothLEDevice;
            }
        }
        BluetoothLEDevice bluetoothLEDevice2 = new BluetoothLEDevice(bluetoothDevice, this.f67c);
        ScanResult scanResult = new ScanResult(bluetoothDevice, null, 0, 0);
        bluetoothLEDevice2.f65sR = scanResult;
    ...
    public boolean deviceInList(BluetoothDevice bluetoothDevice) {
        for (int i = 0; i < this.deviceList.size(); i++) {
            if (((BluetoothLEDevice) this.deviceList.get(i)).f62d.getAddress().equalsIgnoreCase(bluetoothDevice.getAddress())) {
                return true;
            }
        }
        return false;
