...
public interface zzkc extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzkc {
        ...
        private static class C1134zza implements zzkc {
        ...
        public static zzkc zzan(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzkc)) ? new C1134zza(iBinder) : (zzkc) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            String str = "com.google.android.gms.auth.api.accountstatus.internal.IAccountStatusCallbacks";
            if (i == 2) {
