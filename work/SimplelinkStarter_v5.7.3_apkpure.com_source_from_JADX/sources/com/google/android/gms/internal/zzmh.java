...
abstract class zzmh<K, V> {
    ...
    final class zzc implements Set<K> {
        ...
        public boolean remove(Object obj) {
            int colIndexOfKey = zzmh.this.colIndexOfKey(obj);
            if (colIndexOfKey < 0) {
                return false;
            }
        ...
        public <T> T[] toArray(T[] tArr) {
            return zzmh.this.toArrayHelper(tArr, 0);
        }
    }
    ...
    final class zzd implements Iterator<Entry<K, V>>, Entry<K, V> {
        ...
        public V setValue(V v) {
            if (this.mEntryValid) {
                return zzmh.this.colSetValue(this.mIndex, v);
            }
            throw new IllegalStateException("This container does not support retaining Map.Entry objects");
        }
    ...
    final class zze implements Collection<V> {
        ...
        public boolean remove(Object obj) {
            int colIndexOfValue = zzmh.this.colIndexOfValue(obj);
        ...
        public <T> T[] toArray(T[] tArr) {
            return zzmh.this.toArrayHelper(tArr, 1);
        }
    }
