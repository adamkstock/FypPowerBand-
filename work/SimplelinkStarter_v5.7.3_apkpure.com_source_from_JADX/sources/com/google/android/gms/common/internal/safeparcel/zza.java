...
public class zza {
    ...
    public static class C1121zza extends RuntimeException {
        public C1121zza(String str, Parcel parcel) {
    ...
    public static int zzap(Parcel parcel) {
        ...
        sb2.append("Expected object header. Got 0x");
        sb2.append(Integer.toHexString(zzao));
