...
public class TimeProfile {
    ...
    public static BluetoothGattService createTimeService() {
        ...
        BluetoothGattCharacteristic currentTime = new BluetoothGattCharacteristic(CURRENT_TIME, BluetoothGattCharacteristic.PROPERTY_READ | BluetoothGattCharacteristic.PROPERTY_NOTIFY, BluetoothGattCharacteristic.PERMISSION_READ);
